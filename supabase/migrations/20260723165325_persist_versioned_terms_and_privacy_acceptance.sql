...
begin
  v_acceptance_mechanism := coalesce(p_metadata ->> 'acceptance_mechanism', '');
  ...
  if v_email = '' or char_length(v_email) > 254
    ...
    or v_acceptance_mechanism <> 'signup_checkbox'
    ...
    values
      (
        ...
        jsonb_build_object(
          ...
          'mechanism', new.raw_user_meta_data ->> 'acceptance_mechanism'
        ),
        true,
        v_accepted_at,
        v_evidence_hash
