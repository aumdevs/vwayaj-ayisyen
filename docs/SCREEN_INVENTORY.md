...
| Estados Unidos | `/[locale]/countries/usa` |
| Chile | `/[locale]/countries/chile` |
| Brasil | `/[locale]/countries/brazil` |
| México | `/[locale]/countries/mexico` |
...
Cada ruta localizada existe en kreyòl haitiano, francés, español, portugués e
inglés. No hay pantallas de autenticación, cuenta, administración o servicio
privado.

## PWA

- barra superior adaptada a teléfono y tableta;
- navegación inferior a Inicio, Países, Preguntas, Nosotros y Contacto;
- selector de idioma;
